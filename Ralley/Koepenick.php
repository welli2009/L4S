...
<body>
   ...
   // Begrenzen Sie die Pan- und Zoomm&ouml;glichkeiten auf den Bereich von K&ouml;penick
            ...
            // Beschr&auml;nken Sie den minimalen Zoom
            map.setMinZoom(16); // Hier den gew&uuml;nschten minimalen Zoomwert einstellen

            // Beispiel f&uuml;r 8 Punkte mit unterschiedlichen Zust&auml;nden
            ...
            points.forEach(function (point, index) {
                ...
                pointLink.innerHTML = point.label;
        ...
        function updateLinkStatus(point, link) {
            ...
            if (distance < 75 && point.status === 'locked') {
                ...
                alert("Es gibt ein Punkt in der nähe.");
                ...
                link.className = 'point-link ' + point.status;
                link.removeEventListener('click', null);
            }
        }
